...
| 11. Supabase Migration & Multi-User Backend | 7/8 | In Progress|  |
...
- [x] 11-06-PLAN.md — Wave 4: Idempotent migration runner (chunked upserts, progress UI), Settings "Migrate my data" button, sign-out button, data sharing enforcement
